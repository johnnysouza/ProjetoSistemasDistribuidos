 ...
 * 
 */
@WebServiceClient(name = "LoginWebService", targetNamespace = "http://webservice.furb.br/", wsdlLocation = "http://localhost:9090/login?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOGINWEBSERVICE_QNAME = new QName("http://webservice.furb.br/", "LoginWebService");
     ...
     *     returns LoginWeb
     */
    @WebEndpoint(name = "LoginWebPort")
    public LoginWeb getLoginWebPort() {
        return super.getPort(new QName("http://webservice.furb.br/", "LoginWebPort"), LoginWeb.class);
    }
     ...
     */
    @WebEndpoint(name = "LoginWebPort")
    public LoginWeb getLoginWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.furb.br/", "LoginWebPort"), LoginWeb.class, features);
    }
